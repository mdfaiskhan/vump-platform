...
class _$AuthStateExpiredImpl extends AuthStateExpired {
  const _$AuthStateExpiredImpl() : super._();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$AuthStateExpiredImpl);
  }
...
abstract class AuthStateExpired extends AuthState {
  const factory AuthStateExpired() = _$AuthStateExpiredImpl;
  const AuthStateExpired._() : super._();
}
