...
const LocalSessionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'taskId': PropertySchema(id: 6, name: r'taskId', type: IsarType.string),
  },
...
extension LocalSessionQueryWhere
  ...
  QueryBuilder<LocalSession, LocalSession, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension LocalSessionQueryFilter
  ...
  QueryBuilder<LocalSession, LocalSession, QAfterFilterCondition> taskIdEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalSession, LocalSession, QAfterFilterCondition> taskIdBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<LocalSession, LocalSession, QAfterFilterCondition> taskIdMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension LocalSessionQuerySortBy
  ...
  QueryBuilder<LocalSession, LocalSession, QAfterSortBy> sortByCollectorId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalSession, LocalSession, QAfterSortBy> sortByTaskId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskId', Sort.asc);
    });
  }

  QueryBuilder<LocalSession, LocalSession, QAfterSortBy> sortByTaskIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LocalSessionQuerySortThenBy
  ...
  QueryBuilder<LocalSession, LocalSession, QAfterSortBy> thenByCollectorId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'collectorId', Sort.asc);
    });
  }
  ...
  QueryBuilder<LocalSession, LocalSession, QAfterSortBy> thenByTaskId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskId', Sort.asc);
    });
  }

  QueryBuilder<LocalSession, LocalSession, QAfterSortBy> thenByTaskIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'taskId', Sort.desc);
    });
  }
...
extension LocalSessionQueryWhereDistinct
  ...
  QueryBuilder<LocalSession, LocalSession, QDistinct> distinctByCollectorId({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalSession, LocalSession, QDistinct> distinctByTaskId({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension LocalSessionQueryProperty
  ...
  QueryBuilder<LocalSession, String?, QQueryOperations> collectorIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocalSession, String?, QQueryOperations> taskIdProperty() {
    return QueryBuilder.apply(this, (query) {
