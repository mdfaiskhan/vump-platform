...
Corroborating the inferred mismatch: the Ubuntu images differ in size from the Windows ones (7,351 vs 7,367 bytes dark; 7,513 vs 7,527 light), so the two hosts genuinely render these widgets differently even with no fonts rasterized. | A-027, A-095, Ch. 9.7 §2, open item 48 |
